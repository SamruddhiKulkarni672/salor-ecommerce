	...
	return (
		<div className="mx-auto max-w-screen-xl px-2 py-8">
			...
			<div className="relative">
				<button
					onClick={() => scroll("left")}
					className="absolute left-0 top-1/2 z-20 -translate-y-1/2 rounded-full bg-[#73756166] p-2 shadow md:p-3"
				>
					<FaChevronLeft />
				</button>
						...
						>
							{index === activeVideoIndex ? (
								...
								>
									...
									>
										<div className="relative h-16 w-16" onClick={() => setActiveVideoIndex(index)}>
				...
				<button
					...
					className="absolute right-0 top-1/2 z-20 -translate-y-1/2 rounded-full bg-[#73756166] p-2 shadow md:p-3"
				>
					<FaChevronRight />
				</button>
			</div>
